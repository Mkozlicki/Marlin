...
/*
* Define printer for which the config is applied
* 0 - small test printer
* 1 - big production printer
*/
#define TARGET_PRINTER 0
...
#define DUMMY_THERMISTOR_999_VALUE 180
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 39, 40, 757, 10 }
